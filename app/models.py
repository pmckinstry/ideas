...
class User(UserMixin, db.Model):
    ...
    def __init__(self, username, email, password=None, oauth_provider=None, oauth_id=None):
...
def get_user_by_oauth(oauth_provider, oauth_id):
    ...
    return User.query.filter_by(oauth_provider=oauth_provider, oauth_id=oauth_id).first()
